...
<head>
  ...
  <style>
    ...
    .ball-section {
      ...
      /* Add border around each ball section */
      margin-bottom: 10px;
      /* Add some space between ball sections */
      padding: 10px;
      /* Add padding inside each ball section */
    }
  ...
  <div class="container">
    ...
    <form action="${pageContext.servletContext.contextPath}/establishmentReg" method="post">
      ...
      <div id="ballsList"> &nbsp
        <% if (establishments !=null) { for (Establishment establishment : establishments) { %>
          <div class="ball-section">
            <p>Name: <%= establishment.getEstablishmentName() %>
            </p>
            <p>Address: <%= establishment.getAddress() %>
            </p>
          </div>
          <% } } else { %>
